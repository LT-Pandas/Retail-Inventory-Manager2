...
def main() -> None:
    ...
    if args.button_controlled:
        try:
            ...
            print(
                "Warning: gpiozero is unavailable, so button control is disabled and CV will start immediately. "
                "Install it with `pip install gpiozero` to use GPIO start/stop."
            )
            print(f"Import error: {exc}")
            args.button_controlled = False
